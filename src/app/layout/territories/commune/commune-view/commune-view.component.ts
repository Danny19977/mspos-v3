...
@Component({
  ...
  styleUrl: './commune-view.component.scss'
})
  ...
  fetchProducts(name: string, territoire_uuid: string) {
    if (name == "country") {
      this.countryService.get(this.territoire_uuid).subscribe(item => {
        ...
        this.communeService.getPaginatedByCountryUUId(territoire_uuid, this.current_page, this.page_size, this.search).subscribe(res => {
      ...
      this.provinceService.get(this.territoire_uuid).subscribe(item => {
        this.territoire = item.data;
        this.communeService.getPaginatedByProvinceId(territoire_uuid, this.current_page, this.page_size, this.search).subscribe(res => {
          this.dataList = res.data;
          this.total_pages = res.pagination.total_pages;
          this.total_records = res.pagination.total_records;
          this.dataSource.data = this.dataList; // Update dataSource data
      ...
      this.areaService.get(this.territoire_uuid).subscribe(item => {
        this.territoire = item.data;
        this.communeService.getPaginatedByAreaId(territoire_uuid, this.current_page, this.page_size, this.search).subscribe(res => {
          this.dataList = res.data;
          this.total_pages = res.pagination.total_pages;
          this.total_records = res.pagination.total_records;
          this.dataSource.data = this.dataList; // Update dataSource data
      ...
      this.subAreaService.get(this.territoire_uuid).subscribe(item => {
        this.territoire = item.data;
        this.communeService.getPaginatedBySubAreaId(territoire_uuid, this.current_page, this.page_size, this.search).subscribe(res => {
          this.dataList = res.data;
          this.total_pages = res.pagination.total_pages;
          this.total_records = res.pagination.total_records;
          this.dataSource.data = this.dataList; // Update dataSource data
